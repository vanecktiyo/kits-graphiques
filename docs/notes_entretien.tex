...
Pour valider l'outil de bout en bout, neuf briefs longs et réalistes couvrent les
...
pastille, thème Black Friday, repli sur la promo par défaut, fonds clairs ou foncés
(pour vérifier la variante de logo). Mode d'emploi : saisir 1.1/1.2/1.3, choisir le
fond, cocher tous les formats, générer, puis comparer au résultat attendu.
...
Les neuf briefs du plan ont été exécutés sur l'ensemble des formats. Après une série
de corrections, tous les rendus sont conformes aux résultats attendus. La campagne a
surtout permis de \textbf{détecter et corriger plusieurs anomalies}, ce qui illustre
